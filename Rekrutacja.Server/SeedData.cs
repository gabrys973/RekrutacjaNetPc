...
{
    // klasa służąca do seedowania początkowych danych
    ...
    private static void EnsureUsers(IServiceScope scope)
    {
        ...
        var angella = userMgr.FindByNameAsync("user").Result;
        if(angella == null)
        {
            ...
            result =
                userMgr.AddClaimsAsync(
                    ...
                    new Claim[]
                    {
                        new Claim(JwtClaimTypes.Name, "Adam Nowak"),
                        new Claim(JwtClaimTypes.GivenName, "Adam"),
                        new Claim(JwtClaimTypes.FamilyName, "Nowak"),
